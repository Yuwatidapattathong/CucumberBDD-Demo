...
public class Driver {
    ...
    private static final String sauceKey = ConfigReader.readProperty(propertyPath,"sauceKey");
    private static final String URL = "https://" + sauceUser + ":" + sauceKey + "@ondemand.us-west-1.saucelabs.com:443/wd/hub";

    public static WebDriver getDriver() {
        if (driver == null) {
            if(ConfigReader.readProperty(propertyPath,"executeTestLocally=false").equalsIgnoreCase("false")) {
    ...
    public static WebDriver getRemoteDriver(){
        ...
        try{
            ...
            capabilitie.setCapability("version", ConfigReader.readProperty(propertyPath, "browser_version"));
            capabilitie.setCapability("platform", ConfigReader.readProperty(propertyPath, "os"));
            driver = new RemoteWebDriver(new URL(URL),capabilitie);
